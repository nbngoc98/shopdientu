    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h5 class="pull-right" style="font-size: 15px;">Mời quý khách hàng thanh toán bằng cách chuyển tiền tới tài khoản ngân hàng: Vietcombank - 2511189238373 Electronics Da Nang</h5>
                <p>Chú ý: Ghi rõ lời nhắn "thanh toán mã đơn hàng #<?php echo mt_rand(10000,30000);?>"</p>
            </div>
        </div>
    </div>
</div>
