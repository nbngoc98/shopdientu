...
@endsection
@section('content')
    @include('home::homes.components.content_header', ['name'=> $products->name, 'category'=> $products->category->name])
                    ...
                    <div class="product-details-left">
                        <div class="product-details-images slider-navigation-1">
                            @foreach($products->images as $imageDetail)
                                <div class="lg-image">
                                    <a class="popup-img venobox vbox-item" href="{{$imageDetail->image_path}}" data-gall="myGallery">
                                        <img src="{{$imageDetail->image_path}}" alt="product image">
                                    </a>
                                </div>
                            @endforeach
                        </div>
                        <div class="product-details-thumbs slider-thumbs-1">
                            @foreach($products->images as $imageDetail)
                                <div class="sm-image"><img src="{{$imageDetail->image_path}}" alt="product image thumb"></div>
                            @endforeach
                            @foreach($products->images as $imageDetail)
                                <div class="sm-image"><img src="{{$imageDetail->image_path}}" alt="product image thumb"></div>
                            @endforeach
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="product-details-view-content pt-60">
                        <div class="product-info">
                            <h2>{{ $products->name }}</h2>
                            <span class="product-details-ref">Danh mục: {{$products->category->name}}</span>
                            ...
                            <div class="price-box pt-20">
                                <span class="new-price new-price-2">{{ number_format($products->price) }}đ</span>
                            </div>
