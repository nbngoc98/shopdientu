...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('home.index') }}" class="nav-link">Giao diện người dùng</a>
        </li>
{{--        <li class="nav-item d-none d-sm-inline-block">--}}
...
{{--        </li>--}}
        <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                <img src="{{asset('admins/dist/img/user8-128x128.jpg')}}" class="user-image ml-2 mt-1" alt="User Image">
                <span class="hidden-xs">{{ Auth::guard('admin-web')->user()->name }}</span>
            </a>
            <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                    <img src="{{asset('admins/dist/img/user8-128x128.jpg')}}" class="img-circle" alt="User Image">
