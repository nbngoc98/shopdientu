...
@section('content')
    ...
    @include('admin.layouts.content_header', ['name'=>'Nhân viên', 'key'=>'Chỉnh sửa','name_title'=>'Chỉnh sửa nhân viên'])
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Chỉnh sửa USER-ADMIN</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="role_id[]" class="form-control tags_select_choose" multiple="multiple">
                                            ...
                                            @foreach($roles as $role)
                                                {{-- contains() check trar veef true false--}}
